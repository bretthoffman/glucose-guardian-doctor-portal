/**
 * MIRROR of the trend resolver in glucose_guardian artifacts/mobile/utils/trend.ts (at 2ae6a7fa):
 * mapDexcomTrend, getEffectiveTrend and trendFromDiff, copied unchanged. The rest of that file is app
 * UI (colors, gauge labels) and is not needed here.
 */
export type GlucoseTrend = "rapidly_rising" | "rising" | "stable" | "falling" | "rapidly_falling";
