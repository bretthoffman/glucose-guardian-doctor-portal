/**
 * MIRROR of glucose_guardian artifacts/mobile/utils/doseTuning.ts (at 2ae6a7fa) so the portal calculates
 ...
 */
import type { InsulinLogEntry } from "@doctor-portal/api-client-react";
